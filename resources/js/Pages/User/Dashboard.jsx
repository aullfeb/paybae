...
export default function Dashboard() {
    ...
    const getStatusName = () => {
        ...
        if (!aiData) return "Hemat";
        // Gunakan field spending_pattern langsung dari API (lebih reliable dari parsing regex)
        const pattern = aiData.spending_pattern || "Hemat";
        if (pattern.toLowerCase() === "hemat") return "Hemat";
        return pattern;
    };
