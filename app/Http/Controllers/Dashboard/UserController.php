    ...
    public function recommend(Request $request)
    {
        ...
        try {
            ...
            if ($response->successful()) {
                ...
                //hitung potensi hemat berdasarkan pemotongan belanja dari aksi rekomendasi model AI
                $factorMap = [
                    0 => 0.0,    // Pertahankan pengeluaran (0%)
                    1 => -0.10,  // Boleh naik (-10%)
                    2 => 0.20,   // Kurangi 20%
                    3 => 0.10,   // Kurangi 10%
                    4 => 0.05,   // Kurangi 5%
                ];
                ...
                $reductionPerDay = $avgExpense7d * max(0.0, $factor);
